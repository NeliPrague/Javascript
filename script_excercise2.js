...
// 1.Reset form
function resetForm() {
  document.getElementById("ex1-input-1").value = "";
  document.getElementById("ex1-input-2").value = "";
  document.getElementById("ex1-input-3").value = "";
  document.getElementById("ex1-input-4").value = "";
}
